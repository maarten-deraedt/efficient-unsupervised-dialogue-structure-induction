...
class SWDADialogCorpus(object):
    ...
    def get_dialog_corpus(self):
        def _to_id_corpus(data):
            # media_1[0][1][0], dialog 0, 1st turn, 0 is usr, 1 is sys
            # media_1[0][1][1], dialog 0, 1st, 1 is sys
            results = []
            for dialog in data:
                temp = []
    ...
    def get_state_corpus(self, pad_to_length):
        ...
        #         media_1.append(state_this_dialog)
        #     return media_1
    ...
    #             media_1.append((m_meta, o_meta, self.rev_topic_vocab[topic]))
    #         return media_1
